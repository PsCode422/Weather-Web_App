...
(() => {  
    ...
    document.querySelector('.backgroundImage').setAttribute('src', `https://source.unsplash.com/${newArr[index]}/1600x650`);
})();
...
function backgroundImage() { 
    setInterval(() => {
        ...
        document.querySelector('.backgroundImage').setAttribute('src', `https://source.unsplash.com/${weatherArray[index]}/1600x650`);
    },20000)        
};
